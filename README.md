...
Name: Jeong Min Park, Ophir Maor

## GitHub Pages
- [expose.html](https://jep053.github.io/Lab5_Starter/expose.html)
- [explore.html](https://jep053.github.io/Lab5_Starter/explore.html)
...
Yes, because this is an isolated, simple function that checks if input length exceeds 80 characters. It has clear inputs and outputs, making it perfect for unit testing.
